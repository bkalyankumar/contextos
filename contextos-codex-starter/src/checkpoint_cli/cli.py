...
def setup_user(
    ...
    if written:
        console.print("Created user context files:")
        for path in written:
            console.print(f"- {path}")
    else:
        console.print("User context already exists. Use --overwrite to replace templates.")
...
def init(
    ...
    console.print(f"Initialized ContextOS project at {root}")
    if written:
        console.print("Created files:")
        for path in written:
            console.print(f"- {path.relative_to(root)}")
    else:
        console.print("No files overwritten. Existing files were preserved.")
...
def status(
    ...
    if tasks:
        console.print("\nActive tasks:")
        for task in tasks:
            console.print(f"- {task.relative_to(root)}")
...
def resume(
    ...
    if output:
        ...
        console.print(f"Wrote resume pack to {output}")
    else:
        console.print(pack)
...
def handoff(
    ...
    console.print(f"Created handoff: {target.relative_to(root.resolve())}")
    console.print(f"Updated latest handoff: {paths.latest_handoff.relative_to(root.resolve())}")
...
def show(
    ...
    console.print(read_text(full_path, f"File not found: {full_path}"))
